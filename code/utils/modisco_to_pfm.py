# Purpose: Given the PPMs computed by Modisco, we first trim the PPMs to regions
...
# Ryan Zhao
# https://github.com/kundajelab/cardioid-chd/blob/master/4_tf_profiles/1_unify_modisco.ipynb
